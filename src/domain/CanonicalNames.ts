...
export const BASE_TYPES: readonly BaseTypeInfo[] = [
  ...
  { russian: 'ХранилищеЗначения',       english: 'ValueStorage',     xmlPrimitive: 'xs:base64Binary', contexts: ['metadataAttribute', 'formAttribute'] },
  { russian: 'УникальныйИдентификатор', english: 'UUID',                                              contexts: ['metadataAttribute', 'formAttribute'] },
  { russian: 'ДвоичныеДанные',          english: 'BinaryData',                                        contexts: ['metadataAttribute', 'formAttribute'] },
